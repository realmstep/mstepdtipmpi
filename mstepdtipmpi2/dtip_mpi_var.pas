...
// для одного процесса
	procMArr, procUpMArr: array of longint; // массив кол-ва заявок по процессам
    procM: longint; // количество заявок
	procUpM, procDownM: longint; // начальная и конечная заявка для процесса
	tprocUpM: longint; // начальная и конечная заявка для процесса
...
var
	...
	procDownNcArr: array of longint;
